    ...
    return (
        <div>
            ...
            <form className='mt-3 article_form' onSubmit={formik.handleSubmit}>
                ...
                <div className='form-group'>
                    <WYSIWYG setEditorState={(state)=>handleEditorState(state)} setEditorBlur={(blur)=>handleEditorBlur(blur)} onError={formik.errors.content} editorBlur={editorBlur} />
                ...
                <Divider className='mt-3 mb-3' />
                {articles.loading? <Loader />: <Button variant='contained' color='primary' type='submit'>Add article</Button> }
